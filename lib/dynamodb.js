...
const getQueryParams = ( partitionKey, params ) => {
	return {
		KeyConditionExpression: 'partitionKey = :pk',
		FilterExpression: params.filter,
		ExpressionAttributeValues: Object.assign( { ':pk': partitionKey }, params.params ),
...
const fetchPartition = ( partitionKey, params, callback ) => {
	...
	const query = getQueryParams( partitionKey, params );
	console.dir( query );
